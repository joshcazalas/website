...
try {
  ...
  assert.match(await page.locator('#auxide-panel .project-details').innerText(),/bounded mailbox/);
  ...
  console.log('Passed: mobile direct link, controls, project details, reduced motion, and silent default.');
